export const nl = {
  translation: {
    ...
    goToDiscussion: 'Ga naar discussie',
    question: 'Vraag',
    completed: 'voltooid',
    ...
    startAssignments: 'Start opdrachten',
    noNotStartedAssignments: 'Geen opdrachten om te starten',
    latestDiscussions: 'Recentste discussies',
    noLatestDiscussions: 'Geen recente discussies',
